    ...
    try{
      const res=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"Content-Type":"application/json"},
        body:JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:1000,
          system:"You are a senior Pakistan real estate sales strategist. Review this ARD City Sales Plan and produce an Executive Intelligence Brief with 3 sections: STRENGTHS, GAPS, TOP 3 RECOMMENDATIONS. Be direct and Pakistan-market-specific.",
          messages:[{role:"user",content:`Review:\n\n${t}`}]})});
      const d=await res.json();setAiLog(d.content?.map(b=>b.text).join("")||"No response.");
